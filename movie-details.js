document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fetch and display top 5 cast details
    fetch(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=${apiKey}&language=en-US`)
        .then(response => response.json())
        .then(data => {
            const topActors = data.cast.slice(0, 4); // Get the top 5 actors
    ...
    commentForm.addEventListener('submit', function(event) {
        ...
        // Placeholder for submitting comment logic
    ...
    ratingForm.addEventListener('submit', function(event) {
        ...
        // Placeholder for submitting rating logic
